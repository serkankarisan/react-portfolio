const styles = {
  ...
  heroHeadText:
    'font-extralight text-eerieBlack lg:text-[80px] sm:text-[50px] xs:text-[50px] text-[40px] lg:leading-[90px] mt-2',
  heroSubText:
    'font-extralight text-eerieBlack font-medium lg:text-[30px] sm:text-[20px] xs:text-[20px] text-[16px] lg:leading-[40px]',
